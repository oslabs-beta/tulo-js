...
const imageUrls = [/**Enter paths of images to cache **/];
const pageUrls = [/**Enter paths of pages to cache **/];
const staticUrls = [/**Enter paths of static files (e.g. css, js) to cache **/];
